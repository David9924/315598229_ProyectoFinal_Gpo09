...
int main()
{
    ...
    Model Navyc((char*)"Models/Navy/navycuerpo.obj");
    Model Navyala((char*)"Models/Navy/navyala1.obj");
    Model Navyala2((char*)"Models/Navy/navyala2.obj");
    Model Cofrear((char*)"Models/Cofre/Cofreab.obj");
    Model Cofreab((char*)"Models/Cofre/Cofreabaj.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
       ...
       // centro.Draw(lightingShader);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.1f, 0.1f, 0.1f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 1.0f, 1.0f, 1.0f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 10.0f, 10.0f, 10.0f);
        glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shininess"), 60.0f);
        ...
        Navyala.Draw(lightingShader);

        //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.0f, 0.0f, 0.0f);
        //// glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.0f, 0.0f, 0.0f);
        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(5.0f, 0.0f, 2.0f));
        Navyala2.Draw(lightingShader);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.1f, 0.1f, 0.1f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 1.0f, 1.0f, 1.0f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 50.0f, 50.0f, 50.0f);
        glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shininess"), 250.0f);
